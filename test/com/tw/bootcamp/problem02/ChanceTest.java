...
class ChanceTest {
    ...
    void shouldReturnProbabilityOfGettingTails() {
        Chance chance = Chance.create(1,2, 1);
    ...
    void shouldReturnProbabilityOfNotGetting3_whenRollDice() {
        Chance chance = Chance.create(1 ,6, 1);
        assertEquals(83.33, chance.chanceOfNotGettingAFace(), 0.01);
    }
}
